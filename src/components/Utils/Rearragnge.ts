...
function filterDataByOwnerStatus(
  ...
  console.log("start--filterDataByOwnerStatus");
  console.log("filteredDataNotDone");
  console.log(filteredDataNotDone);
  console.log("filteredDataDone");
  console.log(filteredDataDone);
  console.log("end--filterDataByOwnerStatus");
...
function filterDataByMessageStatus(
  ...
  console.log("start--filterDataByMessageStatus");
  console.log("filteredDataNotViewed");
  console.log(filteredDataNotViewed);
  console.log("filteredDataViewed");
  console.log(filteredDataViewed);
  console.log("end--filterDataByMessageStatus");
...
function SortByOwner(
  ...
  console.log("start--SortByOwner");
  console.log("Ownerslist");
  console.log(Ownerslist);
  console.log("filteredDataViewed");
  console.log(Otherslist);
  console.log("end--SortByOwner");
